...
public class Diagonal1 {
	...
	private void colocaPalabra() {
		...
		/**
		 * Lo primero que hacemos es determinar en que espacio del vector ir� alojada la �ltima letra de la palabra
		 * */
		...
		yInicial = ejeY;
		/**
		 * Una vez lo hemos hallado, determinamos donde ir� alojada la primera letra
		 * */
